...
public class NettyServerConfig extends NettyBaseConfig {
    ...
    public String getWorkerThreadPrefix() {
        return CONFIG.getConfig(ConfigurationKeys.WORKER_THREAD_PREFIX,
            enableEpoll() ? EPOLL_WORKER_THREAD_PREFIX : DefaultValues.DEFAULT_NIO_WORKER_THREAD_PREFIX);
    }
    ...
    public String getExecutorThreadPrefix() {
        return CONFIG.getConfig(ConfigurationKeys.SERVER_EXECUTOR_THREAD_PREFIX,
        		DefaultValues.DEFAULT_EXECUTOR_THREAD_PREFIX);
    }
    ...
    public int getBossThreadSize() {
        return CONFIG.getInt(ConfigurationKeys.BOSS_THREAD_SIZE, DefaultValues.DEFAULT_BOSS_THREAD_SIZE);
    }
    ...
    public int getServerShutdownWaitTime() {
        return CONFIG.getInt(ConfigurationKeys.SHUTDOWN_WAIT, DefaultValues.DEFAULT_SHUTDOWN_TIMEOUT_SEC);
    }
