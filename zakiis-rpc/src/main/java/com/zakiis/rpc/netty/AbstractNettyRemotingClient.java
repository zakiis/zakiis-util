...
import com.zakiis.rpc.RemotingClient;
import com.zakiis.rpc.TransactionMessageHandler;
import com.zakiis.rpc.discovery.loadbalance.LoadBalanceFactory;
...
import com.zakiis.rpc.processor.Pair;
...
import com.zakiis.rpc.protocol.ProtocolConstants;
import com.zakiis.rpc.protocol.RpcMessage;
import com.zakiis.rpc.protocol.transaction.AbstractGlobalEndRequest;
import com.zakiis.rpc.protocol.transaction.BranchRegisterRequest;
import com.zakiis.rpc.protocol.transaction.BranchReportRequest;
import com.zakiis.rpc.protocol.transaction.GlobalBeginRequest;
...
public abstract class AbstractNettyRemotingClient extends AbstractNettyRemoting implements RemotingClient {
    ...
    public AbstractNettyRemotingClient(NettyClientConfig nettyClientConfig, EventExecutorGroup eventExecutorGroup,
        ...
        clientChannelManager = new NettyClientChannelManager(new NettyPoolableFactory(this, clientBootstrap), nettyClientConfig);
    }
    ...
    private class MergedSendRunnable implements Runnable {
        ...
        public void run() {
            while (true) {
                ...
                basketMap.forEach((address, basket) -> {
                    ...
                    MergedWrapMessage mergeMessage = new MergedWrapMessage();
        ...
        private void printMergeMessageLog(MergedWrapMessage mergeMessage) {
            if (LOGGER.isDebugEnabled()) {
