...
public class NettyClientConfig extends NettyBaseConfig {
    ...
    private static final long RPC_RM_REQUEST_TIMEOUT = CONFIG.getLong(ConfigurationKeys.RPC_RM_REQUEST_TIMEOUT, DefaultValues.DEFAULT_RPC_RM_REQUEST_TIMEOUT);
    private static final long RPC_TM_REQUEST_TIMEOUT = CONFIG.getLong(ConfigurationKeys.RPC_TM_REQUEST_TIMEOUT, DefaultValues.DEFAULT_RPC_TM_REQUEST_TIMEOUT);
    ...
    private static final boolean ENABLE_CLIENT_BATCH_SEND_REQUEST = CONFIG.getBoolean(ConfigurationKeys.ENABLE_CLIENT_BATCH_SEND_REQUEST
    		, DefaultValues.DEFAULT_ENABLE_CLIENT_BATCH_SEND_REQUEST);
    ...
    public int getClientSelectorThreadSize() {
        return CONFIG.getInt(ConfigurationKeys.CLIENT_SELECTOR_THREAD_SIZE, DefaultValues.DEFAULT_SELECTOR_THREAD_SIZE);
    }
    ...
    public String getClientSelectorThreadPrefix() {
        return CONFIG.getConfig(ConfigurationKeys.CLIENT_SELECTOR_THREAD_PREFIX, DefaultValues.DEFAULT_SELECTOR_THREAD_PREFIX);
    }
    ...
    public String getClientWorkerThreadPrefix() {
        return CONFIG.getConfig(ConfigurationKeys.CLIENT_WORKER_THREAD_PREFIX, DefaultValues.DEFAULT_WORKER_THREAD_PREFIX);
    }
