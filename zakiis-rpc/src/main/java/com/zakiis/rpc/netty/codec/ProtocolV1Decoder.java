package com.zakiis.rpc.netty.codec;
...
import com.zakiis.rpc.compressor.Compressor;
import com.zakiis.rpc.compressor.CompressorFactory;
import com.zakiis.rpc.exception.DecodeException;
...
import com.zakiis.rpc.serializer.HeadMapSerializer;
import com.zakiis.rpc.serializer.Serializer;
import com.zakiis.rpc.serializer.SerializerServiceLoader;
 ...
 * |   code    |Ver  |      (head+body)      |   Length  |Type |lizer|ess  |                       |
 * +-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+
 * |                                                                                               |
 * |                                   Head Map [Optional]                                         |
 * +-----------+-----------+-----------+-----------+-----------+-----------+-----------+-----------+
